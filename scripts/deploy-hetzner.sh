...
sudo mkdir -p "\$(dirname "${SERVER_ENV_FILE}")"
{
  ...
  echo "APP_HOST_PORT=${LOCAL_APP_HOST_PORT}"
  echo "FAMILY_HUB_USERNAME=${LOCAL_APP_USERNAME}"
  echo "FAMILY_HUB_PASSWORD=${LOCAL_APP_PASSWORD}"
  echo "FAMILY_HUB_TIME_ZONE=${LOCAL_TIME_ZONE}"
  echo "FAMILY_HUB_LOCATION_LABEL=${LOCAL_LOCATION_LABEL}"
  echo "FAMILY_HUB_WEATHER_LATITUDE=${LOCAL_WEATHER_LATITUDE}"
  echo "FAMILY_HUB_WEATHER_LONGITUDE=${LOCAL_WEATHER_LONGITUDE}"
